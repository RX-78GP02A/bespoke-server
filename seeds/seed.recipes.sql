...
VALUES  
    ...
    ('Gold Rush', 'Bourbon', '2oz Evan Bonded Bourbon, .75oz lemon, .75oz honey', 'Shake and strain into a Rocks glass, No Garnish.'),
    ('NY Sour', 'Bourbon', '1.5oz Evan Williams 1783, .75oz lemon, .75oz simple', 'Shake and strain over ice into a Rocks glass, Garnish: float of Tilia Malbec'), 
